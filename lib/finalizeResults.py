...
def areaCorrectionFull(pdf, parameters, scanResults):
    ...
    return area_VdM_SG, area_VdM_DG, 1/area_True, (area_VdM_SG - 1/area_True) * area_True, (area_VdM_DG - 1/area_True) * area_True
